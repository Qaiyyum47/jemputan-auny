...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("rsvp-form").addEventListener("submit", function (e) {
    ...
    fetch("https://docs.google.com/forms/d/e/1FAIpQLSehcdS_iM8tRIwi7FqCAGANQS1jQKyz3xs9XNpsxzo7kQ6-iQ/formResponse", {
      method: "POST",
      mode: "no-cors",
      body: data,
    });
...
// ===== UCAPAN FETCH =====
fetch("https://script.google.com/macros/s/AKfycbxc7TZR9WXtn21_B20gctGh5QART7GUw55V3TYdiFTOJ34RibpcbfRFoe-TZCdc_D_1Dw/exec")
  .then(res => res.json())
  .then(data => {
    ...
    count.textContent = `${hadirCount + 100}`;
